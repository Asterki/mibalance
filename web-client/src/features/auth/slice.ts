...
import * as AuthAPITypes from "../../../../shared/types/api/auth.d";
...
export const accountsSlice = createSlice({
	...
	initialState,
	reducers: {
		setAccount: (state, action: PayloadAction<ISessionAccount>) => {
			state.account = action.payload as WritableDraft<ISessionAccount>;
			state.loading = false;
			state.error = null;
		},
		clearAccount: (state) => {
